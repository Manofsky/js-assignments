...
## Javascript Assignments [![Build Status](https://travis-ci.com/Manofsky/js-assignments.svg?branch=master)](https://travis-ci.com/Manofsky/js-assignments)
...
- Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.com/Manofsky/js-assignments/builds).
