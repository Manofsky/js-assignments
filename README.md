...
## Javascript Assignments [![Build Status](https://app.travis-ci.com/Manofsky/js-assignments.svg?branch=master)](https://app.travis-ci.com/Manofsky/js-assignments)
...
- Open https://github.com/Manofsky/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
- Push your updates to github server and check if tests passed on [travis-ci](https://app.travis-ci.com/Manofsky/js-assignments/builds).
